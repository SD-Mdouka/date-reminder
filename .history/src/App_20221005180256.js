...
function App() {
  const ListPerson = [
    { id: 1, name: "صلاح مدوكة", date: "5", img: "" },
    { id: 2, name: "صلاح مدوكة", date: "6", img: "" },
    ,
    { id: 3, name: "صلاح مدوكة", date: "7", img: "" },
    ,
    { id: 4, name: "صلاح مدوكة", date: "5", img: "" },
    { id: 5, name: "صلاح مدوكة", date: "4", img: "" },
  ];
  return (
